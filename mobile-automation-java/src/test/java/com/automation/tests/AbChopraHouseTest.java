...
public class AbChopraHouseTest extends BaseTest {
    ...
    public void testAbChopraHouse_Case1() throws InterruptedException {
        ...
        // ✅ STEP 28: Verify the file is open
        test.log(Status.INFO, "Step 28: Verifying file is open");
        Assert.assertTrue(abChopraHousePage.isFileOpen(),
                "File should be open");
        test.log(Status.PASS, "✓ Step 28: File is open");
